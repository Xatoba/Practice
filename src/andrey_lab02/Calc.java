...
public class Calc {
    ...
    public String calc(int x) {
        ...
        return "Двоичное представление целочисленной площади круга: " + sBinary +
                "\n16-ричное представление целой части значения длины окружности: " + pHex;
    }
